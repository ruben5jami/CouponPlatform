...
<%
Collection<Coupon> collection = (Collection<Coupon>)request.getAttribute("couponscategory");
out.println("<table  id='keywords' >");
out.println("<thead><tr><th>Name</th><th>Description</th><th>Expiry Date</th><th>Price</th><th>Category</th><th>Add To Cart</th></tr></thead><tbody>");
for (Coupon coupon : collection) {
	out.println("<tr><td>"+coupon.getName()+"</td><td>"+coupon.getDescription()+
			"</td><td>"+coupon.getExpiryDate() +
			"</td><td>"+coupon.getPrice() +"</td><td>"+coupon.getCategory() +
			"</td><td><a href='addtocart?id="+coupon.getId() +"'class='btn btn-default btn-sm'><span class='glyphicon glyphicon-shopping-cart'></span> Add to Cart</a></td></tr>");
}
out.println("</tbody></table>");
%>
<h2 class="center"><a href="addtocart"><button type="button" class="btn btn-info">
		<span class="glyphicon glyphicon-shopping-cart"></span> Go To Cart</button></a></h2>
